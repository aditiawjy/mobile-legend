  ...
  try {
    if (req.method === 'PUT') {
      ...
      const counterRows = await query(
        `SELECT counter_hero1, counter_hero2, counter_hero3, counter_hero4, counter_hero5, counter_hero6, counter_hero7, counter_hero8, counter_hero9, counter_hero10, counter_hero11, counter_hero12, counter_hero13, counter_hero14, counter_hero15, counter_hero16, counter_hero17, counter_hero18, counter_hero19, counter_hero20, counter_hero21, counter_hero22,
                counter_reason1, counter_reason2, counter_reason3, counter_reason4, counter_reason5, counter_reason6, counter_reason7, counter_reason8, counter_reason9, counter_reason10, counter_reason11, counter_reason12, counter_reason13, counter_reason14, counter_reason15, counter_reason16, counter_reason17, counter_reason18, counter_reason19, counter_reason20, counter_reason21, counter_reason22
         FROM hero_counter
         WHERE LOWER(hero_name) = LOWER(?)
         LIMIT 1`,
        [name]
      ...
      if (counterRows && counterRows.length > 0) {
        ...
        pushCounter(row.counter_hero19, row.counter_reason19)
        pushCounter(row.counter_hero20, row.counter_reason20)
        pushCounter(row.counter_hero21, row.counter_reason21)
        pushCounter(row.counter_hero22, row.counter_reason22)
      }
