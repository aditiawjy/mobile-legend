      ...
      try {
        ...
        if (infoRes.ok) {
          ...
          if (Array.isArray(info.counters) && info.counters.length > 0) {
            ...
            const c19 = info.counters[18] || {}
            const c20 = info.counters[19] || {}
            const c21 = info.counters[20] || {}
            const c22 = info.counters[21] || {}
            setCounters({
              ...
              counter_hero19: c19.enemy || '',
              counter_hero20: c20.enemy || '',
              counter_hero21: c21.enemy || '',
              counter_hero22: c22.enemy || '',
              ...
              counter_reason19: c19.reason || '',
              counter_reason20: c20.reason || '',
              counter_reason21: c21.reason || '',
              counter_reason22: c22.reason || ''
            })
          } else {
            setCounters({
              counter_hero1: '',
              ...
              <form onSubmit={handleSubmit} className="mb-8">
                ...
                <div className="mt-6 border-t pt-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Hero 7</label>
                        <input
                          type="text"
                          value={counters.counter_hero7}
                          onChange={(e) => handleChangeCounters('counter_hero7', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Opsional"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Reason 7</label>
                        <textarea
                          value={counters.counter_reason7}
                          onChange={(e) => handleChangeCounters('counter_reason7', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Alasan tambahan"
                          rows={2}
                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Hero 8</label>
                        <input
                          type="text"
                          value={counters.counter_hero8}
                          onChange={(e) => handleChangeCounters('counter_hero8', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Opsional"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Reason 8</label>
                        <textarea
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Hero 19</label>
                        <input
                          type="text"
                          value={counters.counter_hero19}
                          onChange={(e) => handleChangeCounters('counter_hero19', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Opsional"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Reason 19</label>
                        <textarea
                          value={counters.counter_reason19}
                          onChange={(e) => handleChangeCounters('counter_reason19', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Alasan tambahan"
                          rows={2}
                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Hero 20</label>
                        <input
                          type="text"
                          value={counters.counter_hero20}
                          onChange={(e) => handleChangeCounters('counter_hero20', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Opsional"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Reason 20</label>
                        <textarea
                          value={counters.counter_reason20}
                          onChange={(e) => handleChangeCounters('counter_reason20', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Alasan tambahan"
                          rows={2}
                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Hero 21</label>
                        <input
                          type="text"
                          value={counters.counter_hero21}
                          onChange={(e) => handleChangeCounters('counter_hero21', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Opsional"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Reason 21</label>
                        <textarea
                          value={counters.counter_reason21}
                          onChange={(e) => handleChangeCounters('counter_reason21', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Alasan tambahan"
                          rows={2}
                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Hero 22</label>
                        <input
                          type="text"
                          value={counters.counter_hero22}
                          onChange={(e) => handleChangeCounters('counter_hero22', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Opsional"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Counter Reason 22</label>
                        <textarea
                          value={counters.counter_reason22}
                          onChange={(e) => handleChangeCounters('counter_reason22', e.target.value)}
                          className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-black focus:ring-black"
                          placeholder="Alasan tambahan"
                          rows={2}
                        />
